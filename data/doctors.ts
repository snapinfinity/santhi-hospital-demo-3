...
export const doctors: Doctor[] = [
  {
    ...
    bio: "Leads the heart failure programme and the hospital's cardiac rehabilitation clinic. Particular interest in women's cardiovascular risk, which is under-recognised and under-treated.",
