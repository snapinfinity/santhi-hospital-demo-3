        ...
        <Reveal>
          <SectionHeading
            ...
            title={
              <>
                Come see us in{" "}
                <em className="font-semibold text-brand not-italic">Kozhikode</em>.
              </>
            }
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          ...
          <Reveal direction="right">
            <div className="flex h-full flex-col rounded-3xl border border-brand-line bg-white p-7 shadow-card sm:p-9">
              <h3 className="font-display text-xl font-medium text-ink">Santhi Hospital</h3>
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                <a
                  ...
                  className="slide-row flex min-h-12 items-center gap-3 rounded-xl bg-brand-wash px-4 py-3 hover:bg-brand-tint"
                >
                ...
                <a
                  ...
                  className="slide-row flex min-h-12 items-center gap-3 rounded-xl bg-accent-wash px-4 py-3 hover:bg-accent-line/60"
                >
                ...
                <a
                  ...
                  className="slide-row flex min-h-12 items-center gap-3 rounded-xl bg-brand-wash px-4 py-3 hover:bg-brand-tint sm:col-span-2"
                >
          ...
          <Reveal direction="left" index={1}>
            <div className="wash-sweep relative flex h-full flex-col overflow-hidden rounded-3xl border border-brand-line p-7 text-ink sm:p-9">
              <div
                aria-hidden="true"
                className="field-grid pointer-events-none absolute inset-0 text-brand/[0.06]"
              />
              <div
                aria-hidden="true"
                ...
                <ul className="mt-6 flex flex-col gap-6">
                  {gettingHere.map((item) => (
                    <li key={item.text} className="group flex items-start gap-4">
                      <span className="grid size-11 shrink-0 place-items-center rounded-full bg-white text-brand shadow-card transition-transform duration-500 ease-out group-hover:-translate-y-1">
                        <item.icon aria-hidden="true" strokeWidth={ICON_STROKE} className="size-5" />
                      </span>
                      <p className="text-[0.95rem] leading-relaxed text-ink-soft">{item.text}</p>
                    </li>
                  ))}
                </ul>
